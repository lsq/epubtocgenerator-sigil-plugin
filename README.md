epubTocGenerator(A Sigil Plugin)
============

A Sigil plugin that helps to generate toc.html / toc.nxc based on rules (or lack thereof).
...
First, clone the repo and cd into it:
    ...
    $ git clone https://github.com/lsq/epubtocgenerator-sigil-plugin.git
    $ cd ./epubtocgenerator-sigil-plugin
...
This will create the epubTocGenerator_vX.X.X.zip file that can then be installed into Sigil's plugin manager.
